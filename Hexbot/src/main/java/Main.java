...
public class Main extends ListenerAdapter
{
   // long Guild = 677299287813783594L; //Guild 14
    ...
    public static void main(String[] args) throws LoginException
    {
        //Hexbot: 
        //HexbotDev:
        JDABuilder builder = JDABuilder.create("KEY DELETED FOR GITHUB", GatewayIntent.GUILD_MESSAGES, GatewayIntent.GUILD_MESSAGE_REACTIONS, GatewayIntent.GUILD_VOICE_STATES, GatewayIntent.GUILD_MESSAGE_TYPING);
